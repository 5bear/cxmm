...
<%
    ...
    String url="joinerm?name="+name+"&fromDatetime="+fromDatetime+"&toDatetime="+toDatetime+"&status="+status+"&";
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript">
    ...
    function find(){
        ...
        location.href="<%=request.getContextPath()%>/Agency/joinerm?name="+name+"&fromDatetime="+fromDatetime+"&toDatetime="+toDatetime+"&status="+status+"&pn=<%=currentPage%>"
    }
    $(function() {
