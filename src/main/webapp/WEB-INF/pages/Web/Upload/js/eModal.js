...
; (function (define) {
    define(['jquery'], function ($) {
        ...
        function alert(params, title) {
            ...
            var $message = $(div).append(_getMessage(params));
        ...
        function confirm(params, title) {
            ...
            return alert({
                async: true,
                buttons: [
                    { close: false, click: click, text: label[params.label] ? label[params.label] : label[defaultSettings.confirmLabel], style: keyDanger },
