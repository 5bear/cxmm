...
<body class="login">
    ...
    <div class="content-img">
      <img src="<%=application.getContextPath()%>/Web/Upload/images/train2.jpg"/>
      <a href="<%=request.getContextPath()%>/Train/sign" id="link1"><img src="<%=application.getContextPath()%>/Web/Upload/images/zxbm.jpg"/></a>
      <a href="<%=request.getContextPath()%>/Train/license" id="link2"><img src="<%=application.getContextPath()%>/Web/Upload/images/zscx.jpg"/></a>
    </div>
