...
<div class="content-img">
    <img src="<%=application.getContextPath()%>/Web/Upload/images/test2.jpg"/>
</div>
<%--<div style="padding-left:250px;padding-right:250px  ">--%>
    <%--<div class="main_content">--%>
        <%--<br>--%>
        <%--<h2 class="title4"><font color="#38C8AA">体质评估简介</font></h2>--%>
        ...
        <%--<h2 class="title4"><font color="#38C8AA">微信扫描二维码进入体质评估</font></h2>--%>
        <%--<div class="title5"></div>--%>
        <%--<h2 class="title4"><img src="<%=request.getContextPath()%>/Web/Upload/images/tizhierweima.jpg" width='200'--%>
                                <%--height='200'/></h2>--%>
        <%--<div class="title5"></div>--%>
        <%--<br><br><br><br>--%>
    <%--</div>--%>
