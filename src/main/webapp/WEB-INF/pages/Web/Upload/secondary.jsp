...
<%
    ...
    String findAgent= (String) request.getAttribute("agent");
    if(findAgent==null)
        findAgent="";
    String status= (String) request.getAttribute("status");
    if(status==null)
        status="";
    String url=request.getContextPath()+"/Agency/secondary?agent="+findAgent+"&status="+status+"&";
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><a href="#"><i class="icon-dashboard"></i>推荐用户管理</a></li>
...
<script type="text/javascript">
    ...
    function findRecord() {
        ...
        location.href="/secondary?agent="+agent+"&status="+status+"&pn=1";
        /*    $.ajax({
