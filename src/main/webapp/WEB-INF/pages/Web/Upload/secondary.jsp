...
<div id="wrapper">
    ...
    <jsp:include page="../Backstage/agentNavi.jsp">
        <jsp:param name="pageName" value="secondary"></jsp:param>
    </jsp:include>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <c:forEach items="${list}" var="agent">
                        <tr>
                            ...
                            <td><label data-toggle="modal" data-target="#EditModal"><a
                                    onclick="setEditid('${agent.id}','${agent.agent}','${agent.phoneNum}','${agent.email}','${agent.qrcode}','${agent.status}')">修改</a></label>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                ...
                <section class="archive-pages">
                    <ul>
                        <li class="first"><a href="#" title="first page">首页</a></li>
                        <li class="previous"><a href="#" title="previous page">上一页</a></li>
                        ...
                        <li class="next"><a href="#" title="next page">下一页</a></li>
                        <li class="last"><a href="#" title="last page">末页</a></li>
                    </ul>
                </section>
            </div>
        </div><!-- /.row -->
                    ...
                    <div class="form-wizard">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">代理点名称</label>
                                <div class="col-md-5">
                                    <input type="text" name="phonenumber" class="form-control" placeholder="代理点"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">手机号</label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">状态</label>
                                <div class="col-md-3">
                                    <select class="form-control col-md-3" name="state">
