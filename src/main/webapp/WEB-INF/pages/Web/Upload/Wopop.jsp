...
<div class="login_padding" id="login_model">
	...
	<form:form modelAttribute="admin" action="" method="post">
		<p class="fieldset">
			<label class="image-replace cd-username">用户名</label>
			<input class="full-width has-padding has-border" name="account" id="sign-email"  placeholder="用户名">
			<span class="cd-error-message">错误的用户信息</span>
		</p>

		<p class="fieldset">
			<label class="image-replace cd-password" >密码</label>
			<input class="full-width has-padding has-border" type="password" name="password" id="sign-password"  placeholder="******">
